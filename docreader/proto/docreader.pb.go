...
type ReadResponse struct {
	...
	Metadata      map[string]string      `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Parser optional metadata (e.g. pdf_preview_path)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_docreader_proto_rawDesc = "" +
	...
	"\x06images\x18\x05 \x03(\v2\x10.docreader.ImageR\x06images\"\xce\x01\n" +
	"\fReadResponse\x12(\n" +
	"\x06chunks\x18\x01 \x03(\v2\x10.docreader.ChunkR\x06chunks\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12A\n" +
	"\bmetadata\x18\x03 \x03(\v2%.docreader.ReadResponse.MetadataEntryR\bmetadata\x1a;\n" +
...
var file_docreader_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_docreader_proto_goTypes = []any{
	...
	nil,                         // 9: docreader.ReadResponse.MetadataEntry
}
var file_docreader_proto_depIdxs = []int32{
	...
	9,  // 7: docreader.ReadResponse.metadata:type_name -> docreader.ReadResponse.MetadataEntry
	4,  // 8: docreader.DocReader.ReadFromFile:input_type -> docreader.ReadFromFileRequest
	5,  // 9: docreader.DocReader.ReadFromURL:input_type -> docreader.ReadFromURLRequest
	8,  // 10: docreader.DocReader.ReadFromFile:output_type -> docreader.ReadResponse
	8,  // 11: docreader.DocReader.ReadFromURL:output_type -> docreader.ReadResponse
